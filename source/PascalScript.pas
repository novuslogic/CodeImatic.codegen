...
function TPascalScriptEngine.ExecuteScript(aPascalFilename: String;aScript: String; aCompileOnly: boolean = false): boolean;
var
  liRetry, I: Integer;
  fbOK: Boolean;
  fbRetry: Boolean;
...
procedure TPascalScriptEngine.RegisterFunctions(aExec: TPSExec);
begin
  RegisterClassLibraryRuntime(aExec, fImp);
end;

procedure TPascalScriptEngine.CompilerOutputMessage;
var
  I: Integer;
begin
...
procedure TPascalScriptEngine.SetVariantToClasses(aExec: TPSExec);
begin
//
end;
