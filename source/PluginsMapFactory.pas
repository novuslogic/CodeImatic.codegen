...
type
  ...
  public
    ...
    class function FindPlugin(aClassname: String; aOutput: tOutput): tPlugin;
  end;
...
class function TPluginsMapFactory.FindPlugin(aClassname: String; aOutput: tOutput): tPlugin;
Var
  fc : TPluginClass;
  f : TPlugin;
begin
